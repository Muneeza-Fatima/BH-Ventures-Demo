...
const VEHICLE_BRANDS = [
    ...
    { name: "Jetour", logo: "/images/brands/Jetour logo.png", photo: "/images/brands/photo/jetour.jpg" },
    { name: "Ferrari", logo: "/images/brands/Ferrari logo.png", photo: "/images/brands/photo/ferrari.png", popular: true },
    { name: "Lamborghini", logo: "/images/brands/Lamborghini logo.png", photo: "/images/brands/photo/Lamborghini.png", popular: true },
    { name: "Hyundai", logo: "/images/brands/Hyundai.png", photo: "/images/brands/photo/hyundai.png" },
    { name: "Porsche", logo: "/images/brands/Porsche logo.png", photo: "/images/brands/photo/porsche.jpg", popular: true },
    { name: "Tesla", logo: "/images/brands/Tesla logo.png", photo: "/images/brands/photo/tesla.png", popular: true },
            ...
            <div className="auto-content">
                ...
                <section className="service-detail-cta auto-cta">
                    ...
                    <div className="service-detail-cta-group">
                        ...
                        <a
                            href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent("Hi, I'd like to request a vehicle quote.")}`}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="service-detail-whatsapp-btn"
                            aria-label={`Chat directly about automobile export on WhatsApp (${BH_WHATSAPP_DISPLAY})`}
                        >
                ...
                <div className="auto-modal-overlay" onClick={closeModal}>
                    <div className="auto-modal" onClick={(e) => e.stopPropagation()}>
                        ...
                        <p className="auto-modal-sub">
                            ...
                            pricing, and export eligibility via WhatsApp (<strong>{BH_WHATSAPP_DISPLAY}</strong>) directly with the dealer.
                        </p>
