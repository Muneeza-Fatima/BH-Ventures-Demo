...
function getInitialLanguage(): string {
  ...
  const saved = window.localStorage.getItem("bh-language");
...
export default function Navbar() {
  ...
  const changeLanguage = (languageCode: string) => {
    ...
    window.localStorage.setItem("bh-language", languageCode);
  ...
  return (
    <>
      ...
      <header className="fixed inset-x-0 top-0 z-[100]">
        ...
        <nav className="mx-auto flex h-[64px] w-full items-center border-b border-white/[0.12] bg-white/[0.035] px-3 shadow-[0_8px_35px_rgba(0,0,0,0.10)] backdrop-blur-2xl backdrop-saturate-150 sm:h-[66px] sm:px-5 md:h-[68px] md:px-8 lg:px-10 xl:h-[70px] xl:px-12">
          {/* LOGO */}
          ...
          <div className="mx-auto hidden items-center gap-1 rounded-full border border-white/[0.07] bg-white/[0.025] px-1.5 py-1 lg:flex xl:gap-1.5">
            {navItems.map((item) => (
              <Link
                key={item.label}
                href={item.href}
                className="group relative flex items-center justify-center rounded-full px-3 py-2 text-[12px] font-extrabold tracking-[0.01em] text-white transition-all duration-300 hover:bg-white/[0.06] hover:text-white xl:px-3.5"
              >
                <span
                  aria-hidden="true"
          ...
          <div className="ml-auto hidden items-center gap-2 lg:flex">
            ...
            <div className="relative">
              <button
                ...
                className="flex h-[36px] items-center gap-2 rounded-full border border-white/[0.12] bg-white/[0.06] px-3 text-[11px] font-bold text-white backdrop-blur-xl transition-all duration-300 hover:border-[#2DD4BF]/50 hover:bg-white/[0.10]"
              >
              ...
              {languageOpen && (
                <div className="absolute right-0 top-[44px] z-[200] w-[185px] overflow-hidden rounded-2xl border border-white/[0.10] bg-[#0B1220]/90 p-1.5 shadow-[0_20px_50px_rgba(0,0,0,0.45)] backdrop-blur-2xl">
            ...
            <Link
              href="/contact"
              className="group relative flex h-[36px] shrink-0 items-center gap-1.5 overflow-hidden rounded-full border border-[#14B8A6]/50 bg-[#14B8A6]/[0.06] px-4 text-[11px] font-bold tracking-[0.01em] text-white transition-all duration-300 hover:border-[#2DD4BF]/80 hover:bg-[#14B8A6]/15"
            >
              <span>Discover Solutions</span>

              <ArrowUpRight className="h-3.5 w-3.5 text-[#2DD4BF] transition-transform duration-300 group-hover:-translate-y-0.5 group-hover:translate-x-0.5" />
            </Link>
          </div>
          ...
          <div className="ml-auto flex shrink-0 items-center gap-1.5 sm:gap-2 md:gap-2.5 lg:hidden">
            ...
            <div className="relative">
              <button
                ...
                aria-label="Select language"
                aria-expanded={languageOpen}
                className="flex h-[32px] items-center gap-1 rounded-full border border-white/[0.12] bg-white/[0.06] px-2 text-[9px] font-extrabold text-white backdrop-blur-xl transition-all duration-300 hover:border-[#2DD4BF]/50 hover:bg-white/[0.10] sm:h-[35px] sm:px-2.5 sm:text-[10px]"
              >
            ...
            <button
              ...
              className="flex h-[32px] w-[32px] shrink-0 items-center justify-center rounded-full border border-white/[0.14] bg-[#0B1220] text-white shadow-[0_6px_18px_rgba(0,0,0,0.25)] transition-all duration-300 hover:border-[#14B8A6]/60 hover:bg-[#102536] sm:h-[35px] sm:w-[35px]"
            >
              {isOpen ? (
