        ...
        >
            ...
            >
                ...
                <p className="web3-quote-sub">
                    Share where you&apos;re at and what you&apos;re building — we&apos;ll connect via WhatsApp (<strong>{BH_WHATSAPP_DISPLAY}</strong>) to talk through the next step.
                </p>
        ...
        <>
            ...
            >
                ...
                <div className="service-detail-cta-group">
                    ...
                    <a
                        href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent("Hi, I'd like to talk about a Web3 venture.")}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="service-detail-whatsapp-btn"
                        aria-label={`Chat directly about Web3 venture studio on WhatsApp (${BH_WHATSAPP_DISPLAY})`}
                    >
